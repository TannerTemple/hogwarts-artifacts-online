...
class ArtifactControllerTest {
    ...
    void tesFindArtifactByIdNotFound() throws Exception {
        // Given
        given(this.artifactService.findById("1250808601744904191")).willThrow(new ObjectNotFoundException("artifact", "1250808601744904191")); //new ObjectNotFoundException("artifact", "1250808601744904191"));
    ...
    void testFindAllArtifactsSuccess() throws Exception {
        ...
        // When and then (combined for controller)
