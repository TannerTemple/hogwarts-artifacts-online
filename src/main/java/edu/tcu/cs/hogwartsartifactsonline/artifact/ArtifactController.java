...
public class ArtifactController {
    ...
    public ArtifactController(ArtifactService artifactService, ArtifactToArtifactDtoConverter
            artifactToArtifactDtoConverter, ArtifactDtoToArtifactConverter artifactDtoToArtifactConverter) {
    ...
    @PutMapping ("/{artifactId}")         //("/{artifactId}")
