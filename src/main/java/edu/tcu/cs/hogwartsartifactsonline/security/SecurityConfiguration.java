...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(CustomBasicAuthenticationEntryPoint customBasicAuthenticationEntryPoint, CustomBearerTokenAuthenticationEntryPoint customBearerTokenAuthenticationEntryPoint, CustomBearerTokenAccessDeniedHandler customBearerTokenAccessDeniedHandler) throws NoSuchAlgorithmException {
        ...
        keyPairGenerator.initialize(2048); //The generated key will have a 2048 bit size
    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/users/**").hasAuthority("ROLE_user") //Protecting this endpoint       //CHANGE TO ROLE USER (tanner)
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/users/**").hasAuthority("ROLE_user") //Protecting this endpoint
                ...
                .csrf(csrf -> csrf.disable())  //cross site request forgery (adds 401 put/post errors, so we disable)
