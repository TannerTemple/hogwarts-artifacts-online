...
public class ExceptionHandlerAdvice {
    ...
    @ExceptionHandler(ObjectNotFoundException.class) //{ArtifactNotFoundException.class, WizardNotFoundException.class}
    ...
    @ExceptionHandler({UsernameNotFoundException.class, BadCredentialsException.class}) //{ArtifactNotFoundException.class, WizardNotFoundException.class}
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    Result handleAuthenticationException(Exception ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "username or password is incorrect.", ex.getMessage());
    }

    @ExceptionHandler(InsufficientAuthenticationException.class) //{ArtifactNotFoundException.class, WizardNotFoundException.class}
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    Result handleAInsufficientAuthenticationException(InsufficientAuthenticationException ex) {
